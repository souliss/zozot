...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public ArrayList<Device> readDBSoulissDevices(SQLiteDatabase readableDatabase, ArrayList<Device> aSoulissDevices) {
		...
		try
		{
			...
			while (myCursor.moveToNext())
			{
				Device d =new Device(Integer.parseInt(myCursor.getString(iColonna_NODE_NUMBER)), Integer.parseInt(myCursor.getString(iColonna_DEVICE_NUMBER)), myCursor.getString(iColonna_TYPICAL_NUMBER), myCursor.getString(iColonna_NODE_NAME));
