...
import com.xively.android.cloudservice.exception.RequestUnsuccessfulException;
...
{
	public static final String INTENT_NAME = "com.xively.android.cloudservice.HttpService";
	...
	public IBinder onBind(Intent intent)
	{
		return new IHttpService.Stub()
		{
			...
			{
				//return put(new UriBuilder().datastreams(feedId).resources(), body, apiKey);
				return put(new UriBuilder().flusso(feedId).resources(), body, apiKey);
